...
public class SingleListDemo {
    public static void main(String[] args) {
        ...
        SingleHeroNode singleHeroNode4 = new SingleHeroNode(5,"鲁智深","花和尚");
        ...
        System.out.println("------------------------------------");
        SingleHeroNode singleHeroNode5 = new SingleHeroNode(6,"秦明","霹雳火");
        singleList.addByNum(singleHeroNode5);
        singleList.showSingleList();
        System.out.println("------------------------------------");
        SingleHeroNode singleHeroNode6 = new SingleHeroNode(5,"jun","修仙者");
